  ...
  const handleResendOtp = async () => {
    if (canResend) {
      ...
      try {
        ...
        if (isPasswordReset) {
          response = await fetch('http://192.168.0.103:3000/auth/reset-password-request', {
            method: 'POST',
            headers: {
          ...
          response = await fetch('http://192.168.0.103:3000/auth/register-phone', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
  ...
  const handleVerifyOtp = async () => {
    ...
    if (otp.length === 6) {
      ...
      try {
        ...
        if (isPasswordReset) {
          response = await fetch(`http://192.168.0.103:3000/auth/reset-password/${resetId}`, {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
          ...
          response = await fetch('http://192.168.0.103:3000/auth/verify-otp', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
